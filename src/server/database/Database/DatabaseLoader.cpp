...
namespace
{
    ...
    std::string const HOTFIXES_DATABASE_INFO_DEFAULT = "127.0.0.1;3306;acore;acore;acore_hotfixes";
    std::string const& GetDefaultDatabaseInfo(std::string_view name)
    {
        ...
        if (name == "Hotfixes")
            return HOTFIXES_DATABASE_INFO_DEFAULT;
...
template AC_DATABASE_API
DatabaseLoader& DatabaseLoader::AddDatabase<HotfixesDatabaseConnection>(DatabaseWorkerPool<HotfixesDatabaseConnection>&, std::string const&);
