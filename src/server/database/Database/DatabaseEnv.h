...
#include "Implementation/HotfixesDatabase.h"
...
/// Accessor to the hotfixes database
AC_DATABASE_API extern DatabaseWorkerPool<HotfixesDatabaseConnection> HotfixesDatabase;
