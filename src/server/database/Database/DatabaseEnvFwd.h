...
class HotfixesDatabaseConnection;
...
using HotfixesDatabasePreparedStatement = PreparedStatement<HotfixesDatabaseConnection>;
...
using HotfixesDatabaseTransaction = SQLTransaction<HotfixesDatabaseConnection>;
...
using HotfixesDatabaseQueryHolder = SQLQueryHolder<HotfixesDatabaseConnection>;
